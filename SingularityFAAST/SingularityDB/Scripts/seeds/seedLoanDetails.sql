...
INSERT INTO #tempLoanDetails([LoanMasterId],[LoanDate],[LoanDuration],[InventoryItemId],[Purpose],[PurposeType],[ClientOutcome],[Notes])
     VALUES
		   ...
		   (3,GETDATE(),28,9,'Assist in decision making (device trial or evaluation)','Education','AT will meet needs',''),
		   ...
		   (7,GETDATE(),28,10,'Assist in decision making (device trial or evaluation)','Employment','AT will meet needs',''),
		   (8,GETDATE(),28,11,'Assist in decision making (device trial or evaluation)','Community Living','AT will meet needs',''),
		   (9,GETDATE(),28,13,'Assist in decision making (device trial or evaluation)','Education','AT will meet needs','')
