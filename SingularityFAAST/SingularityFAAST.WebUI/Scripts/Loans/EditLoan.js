(function($) {
        ...
        function removeItemFromLoan(sendThis) {  //change this to onload the fake clients table loads with dyanamically created x's.  Remove this method. See below.
            var pathToControllerMethod = "/Loan/DeleteIteminEdit/"; 
            var methodArguments = "?searchString=" + sendThis;
